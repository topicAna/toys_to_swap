...
-- -----------------------------------------------------
-- Table `toys_to_swap`.`participate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `toys_to_swap`.`participate` (
  `user_id` INT NOT NULL,
  `event_id` INT NOT NULL,
  INDEX `fk_participate_user1_idx` (`user_id` ASC),
  INDEX `fk_participate_event1_idx` (`event_id` ASC),
  ...
  CONSTRAINT `fk_participate_event1`
    ...
    REFERENCES `toys_to_swap`.`event` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
